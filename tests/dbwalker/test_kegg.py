...
class TestGetKeggIdFromCid(TestCase):
    ...
    def test_api_error_status_code(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            with self.assertLogs("cobramod.DBWalker.Kegg", level="ERROR") as cm:
                result = self.kegg.get_kegg_id_from_cid("999999")

                self.assertIsNone(result)
                self.assertEqual(
                    cm.output,
                    [
                        "ERROR:cobramod.DBWalker.Kegg:Error (404) getting KEGG compound ID from 999999"
                    ],
                )
    ...
    def test_empty_response(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            result = self.kegg.get_kegg_id_from_cid("nonexistent")
    ...
    def test_whitespace_only_response(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            result = self.kegg.get_kegg_id_from_cid("test")
    ...
    def test_request_exception(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            with self.assertRaises(requests.exceptions.RequestException):
                self.kegg.get_kegg_id_from_cid("test")
    ...
    def test_url_construction(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            self.kegg.get_kegg_id_from_cid("12345")

            mock_get.assert_called_once_with(
                "https://rest.kegg.jp/conv/compound/pubchem:12345"
            )
